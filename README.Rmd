...
`r knitr::include_graphics("inst/app/www/RInno.png", dpi = 1250)`
...
[![CRAN_Status_Badge](http://www.r-pkg.org/badges/version/RInno)](https://cran.r-project.org/package=RInno)
